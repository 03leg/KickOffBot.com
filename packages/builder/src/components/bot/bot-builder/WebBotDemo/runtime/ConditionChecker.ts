...
export class ConditionChecker {
  public static check(element: ConditionUIElement, utils: WebBotManagerUtils, userContext: WebUserContext): boolean {
  ...
  private static checkItem(item: ConditionItem, utils: WebBotManagerUtils, userContext: WebUserContext): boolean {
