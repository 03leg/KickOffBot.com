      ...
      <div>
        <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
          <div className="flex flex-col justify-center">
            ...
            <PlayCircleOutlineIcon onClick={() => { setModalOpen(true) }} className="absolute inset-0 max-w-full mx-auto md:max-w-none text-gray-400" sx={{ fontSize: '4rem', margin: 'auto', cursor: 'pointer' }} />
          </div>
