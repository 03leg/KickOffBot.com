        ...
        <Layout>
            <Box sx={{ padding: (theme) => theme.spacing(2), maxWidth: '800px', margin: '0 auto' }}>
                ...
                <Typography variant="body1" paragraph>
                    At kickoffbot.com, accessible from{' '}
                    <Link href="https://www.kickoffbot.com">https://www.kickoffbot.com</Link>, one of our main priorities is the privacy
                    of our visitors. This Privacy Policy document contains types of information that is collected and recorded by
                    kickoffbot.com and how we use it.
                </Typography>
                <Typography variant="body1" paragraph>
                ...
                <Typography variant="body1" paragraph>
                    ...
                    to the information that they shared and/or collect in kickoffbot.com. This policy is not applicable to any
                ...
                <Typography variant="body1" paragraph>
                    kickoffbot.com follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <Typography variant="body1" paragraph>
                    You may consult this list to find the Privacy Policy for each of the advertising partners of kickoffbot.com.
                </Typography>
                <Typography variant="body1" paragraph>
                    Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
                    in their respective advertisements and links that appear on kickoffbot.com, which are sent directly to users
                ...
                <Typography variant="body1" paragraph>
                    Note that kickoffbot.com has no access to or control over these cookies that are used by third-party advertisers.
                </Typography>
                <Typography variant="h6" gutterBottom>
                    Third Party Privacy Policies
                </Typography>
                <Typography variant="body1" paragraph>
                    kickoffbot.com&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                ...
                <Typography variant="body1" paragraph>
                    kickoffbot.com does not knowingly collect any Personal Identifiable Information from children under the age of
