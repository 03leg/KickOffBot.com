...
export class ChangeArrayVariableHelper {
  public static getArrayValue(workflow: ChangeArrayVariableWorkflow, variable: BotVariable, userContext: UserContext, utils: MyBotUtils) {
  ...
  private static checkValue(userContext: UserContext, utils: MyBotUtils, condition: PropertyConditionItem, value: unknown): boolean {
  ...
  private static getConditionValue(userContext: UserContext, utils: MyBotUtils, condition: PropertyConditionItem): unknown {
  ...
  public static getArrayValueByPath(source: ValuePathDescription, userContext: UserContext, utils: MyBotUtils): unknown[] {
  ...
  public static getVariableValue(source: ValuePathDescription, userContext: UserContext, utils: MyBotUtils) {
